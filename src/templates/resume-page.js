            ...
            <div className="my-auto">
              ...
              <div class="resume-item d-flex flex-column flex-md-row mb-5">
                <div class="resume-content mr-auto">
                  ...
                  <h6 class="mb-3 mt-2">Modern Marketing Concepts</h6>
                  <p>
                    <ul>
              ...
              <div class="resume-item d-flex flex-column flex-md-row mb-5">
                <div class="resume-content mr-auto">
                  ...
                  <h6 class="mb-3 mt-2">Invaluable.com</h6>
                  ...
                  <ul>
                    ...
                    <li>
                      Worked in house and remote with Invaluable to ensure their
                      live video streaming feature could be released.
                    </li>
                  </ul>
                </div>
                <div class="resume-date text-md-right">
              ...
              <div class="resume-item d-flex flex-column flex-md-row mb-5">
                <div class="resume-content mr-auto">
                  ...
                  <h6 class="mb-3 mt-2">LifeSite</h6>
                  <ul>
                ...
                <div class="resume-date text-md-right">
                  <span class="text-primary">January 2016 - October 2017</span>
                </div>
              </div>
              ...
              <div class="resume-item d-flex flex-column flex-md-row mb-5">
                <div class="resume-content mr-auto">
                  <h3 class="mb-0">Lead Software Engineer</h3>
                  <h6 class="mb-3 mt-2">Security Mutual Life Insurance</h6>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      information from vendors; recommending purchases; testing
              ...
              <div class="resume-item d-flex flex-column flex-md-row mb-5">
                <div class="resume-content mr-auto">
                  ...
                  <h6 class="mb-3 mt-2">SportsAndLeisureMag.com</h6>
                  <ul>
                    <li>
                      Designed, developed, and deployed custom Drupal site.
                    </li>
              ...
              <div class="resume-item d-flex flex-column flex-md-row mb-5">
                <div class="resume-content mr-auto">
                  ...
                  <h6 class="mb-3 mt-2">CyberCity</h6>
                  <ul>
                    <li>
                      Developed site content and graphics by coordinating with
                      copywriters and graphic artists; designing images, icons,
                      banners, audio enhancements, etc.
                    </li>
                    <li>
